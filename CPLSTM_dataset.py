...
def get_dataset(args, device, visualization=False):
    ...
    elif args.dataset == 'GOOG':
        loc = datasets.goog.get_data(missing_rate, seq_len, pred_len, stride_len, note)
    elif args.dataset == 'MSFT':
        loc = datasets.msft.get_data(missing_rate, seq_len, pred_len, stride_len, note)
    elif args.dataset == 'AAPL':
        loc = datasets.aapl.get_data(missing_rate, seq_len, pred_len, stride_len, note)
    elif args.dataset == 'weather':
        loc = datasets.weather.get_data(missing_rate, seq_len, pred_len, stride_len, note)
    elif args.dataset == 'exchange':
        loc = datasets.exchange.get_data(missing_rate, seq_len, pred_len, stride_len, note)
    ...
    if visualization or 'LSTM' or 'PeepholeLSTM' in args.model:
