...
def parse_args():
    parser = argparse.ArgumentParser(description='CPLSTM')
    ...
    parser.add_argument('--model', type=str, default='peepholeLSTM', help='Model Name')
    ...
    parser.add_argument('--data_name', type=str, default='AAPL')
    parser.add_argument('--norm', type=int, default=10, help='Maxnorm')
    ...
    parser.add_argument('--note', type=str, default="0126", help='date')

    parser.add_argument('--n_classes', type=int, default=2, help='number of class in classification')

    # forecasting
    parser.add_argument('--seq_len', type=int, default=144, help='look_window')
    parser.add_argument('--pred_len', type=int, default=24, help='forecast window')
    parser.add_argument('--stride_len', type=int, default=1, help='stride window')

    parser.add_argument('--dataset', default="AAPL", type=str)
    # random missing
